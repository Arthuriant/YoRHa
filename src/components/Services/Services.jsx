...
const ServiceData = [
  {
    ...
    icon: <FaRobot className="text-4xl sm:text-7xl text-white" />, // old gold tone
    aosDelay: "300",
  },
  {
    ...
    icon: <FaEye className="text-4xl sm:text-7xl text-white" />, // silver accent
    aosDelay: "300",
  },
  {
    ...
    icon: <FaWrench className="text-4xl sm:text-7xl text-white" />, // cold steel
    aosDelay: "300",
  },
];
          ...
          <div data-aos="fade-up" data-aos-delay="300" className='flex flex-col md:flex-row gap-4 bg-[#2F2F2F]/80 text-white p-4 '>
            ...
            <div className='p-4 w-full md:w-1/2 font-orbitron text-sm sm:text-lg  mt-5' >
              <div>
                <Typewriter
                  words={[operatorText]}
                  loop={1} // tampilkan sekali
                  cursor
                  cursorStyle='_'
                  typeSpeed={70}
                  deleteSpeed={0}
                  delaySpeed={Infinity} // jangan delay reset
                />
